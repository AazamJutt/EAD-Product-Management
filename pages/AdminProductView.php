...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="./AdminProductView.php">View Product</a>
              </li>
            </ul>
          </div>
        </div>
  ...
  <div class="container mb-5">
    ...
    <?php
        ...
        $sql = "SELECT  product.ProductId,product.PicURL,product.Name,
                        type.TypeName,
                        product.Price,product.Description,
                        admin.Name as admin,
                        product.UpdatedOn 
                FROM product 
                INNER JOIN admin ON admin.AdminId = product.UpdatedBy 
                ...
                <div class='align-items-center p-2 text-center'>
                  ...
                  <form action='' method='post' enctype='multipart/form-data'>
                    <figcaption>
                      ...
                      <p class='card-text'>Updated By: $updatedBy</p>
                      <p class='card-text'>Updated On: $date</p>
                      <p class='card-text'>Description: $desc</p>
                    </figcaption>
                    <div class='dropdown-divider'></div>
                    <input type='hidden' value=$id name='productId'/>
                    <div>
                      <button name='btnEdit' type='submit' class='btn btn-outline-primary custom-btn float-center'>Edit</button>
                      <button name='btnDelete' type='submit' class='btn btn-outline-danger custom-btn float-center'>Delete</button>
                    </div>
                  </form>
                </div>
              </div>
