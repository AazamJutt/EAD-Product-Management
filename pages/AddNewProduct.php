...
<html lang="en">
  ...
  <?php
      ...
      if(isset($_REQUEST["btnAdd"])){
        ...
        $query = "INSERT INTO `product`(`Name`, `TypeId`, `Price`, `Description`, `PicURL`, `UpdatedOn`, `UpdatedBy`) VALUES ('$name','$type','$price','$desc','$new_name','$date','$admin')";
        ...
        <form action="" method="post" enctype="multipart/form-data">
          <div class="card rounded border-danger shadow-lg">
            ...
            <div class="p-4">
              ...
              <div class="input-group mb-3">
                <select class="col-12 form-control" id="type" name="type" required>
              ...
              <div class="d-flex justify-content-center d-grid">
                <button type="submit" class="btn btn-danger" name="btnAdd" id="btnAdd">Add Product</button>
              </div>
            </div>
          </div>
        </form>
